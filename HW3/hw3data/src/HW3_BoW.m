...
% Last modified: 18-Dec-2015    
    ...
    methods (Static)
        function main()
            ...
            trD  = HW3_BoW.cmpFeatVecs(trIds, scales, normH, normW, bowCs);
            tstD = HW3_BoW.cmpFeatVecs(tstIds, scales, normH, normW, bowCs);
            save('bows.mat','trD','tstD','trLbs');
            
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Write code for training svm and prediction here            %
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % see scene_classify.m
        end;
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            opts.maxIter=20;
            opts.verbose=1;
            bowCs=Kmeans(randWins,1000,opts);
        end;
        ...
        function D = cmpFeatVecs(imIds, scales, normH, normW, bowCs)
            ...
            D = cat(2, D{:});
            D = double(D);
            % D = sqrt(D); % added by yang wang (yangwangx@gmail.com)
